...
@Entity
@Table(name = "phonepe_settlement_data")
public class PhonePeSettlementData {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "phonepe_settle_id", nullable = false)
    private long phonePeSettleId;
    ...
    public long getPhonePeSettleId() {
        return phonePeSettleId;
    }

    public void setPhonePeSettleId(long phonePeSettleId) {
        this.phonePeSettleId = phonePeSettleId;
    }
